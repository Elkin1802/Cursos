...
$sentencia_select = $conexion->prepare('SELECT *FROM usuario ORDER BY identificacion DESC');
                ...
                <?php foreach ($resultado as $fila) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="../Usuario/delete_usuario.php?id=<?php echo $fila['identificacion']; ?>" class="btn__delete" id="agg"><i class="bi bi-trash-fill"></i></a>
